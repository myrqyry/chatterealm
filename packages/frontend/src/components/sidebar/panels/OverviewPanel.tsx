  ...
  return (
    <div className="py-4">
      ...
      <div className="rounded-md p-3 mb-3 border bg-[var(--color-surface-variant)]/60 border-[var(--color-outline)]">
        <h4 className="text-[var(--color-text-primary)] text-sm font-semibold m-0 flex items-center gap-1.5">🗺️ World Status</h4>
      ...
      {currentPlayer && (
        <div className="rounded-md p-3 mb-3 border bg-[var(--color-surface-variant)]/60 border-[var(--color-outline)]">
          <h4 className="text-[var(--color-text-primary)] text-sm font-semibold m-0 flex items-center gap-1.5">🧑 Player</h4>
          <div className="grid grid-cols-2 gap-1.5 text-xs">
